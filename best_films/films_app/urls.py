...
urlpatterns = [
    ...
    path('<str:username>/movies', UserMoviesList.as_view(), name='user_movies'),
    # path('<str:username>/movies/category/<int:category_id>', UserViewsView.as_view(), name='user_movies_category'),
